                    ...
                    <div class="card card-bordered">
                        <div class="card-inner">
                            ...
                            <div class="container">
                                ...
                                @if (isset($data))
                                    <a class="btn btn-primary" href="{{ asset('upload_file/' . $data->name) }}"
                                        target="_blank">
                                        Download Issuer Code
                                    </a>
                                @endif
                            </div>
                        </div>
            ...
            <div class="modal-content" >
                ...
                <div class="modal-body" style="font-family: 'Open Sans', sans-serif;">
                    ...
                    <div class="row gy-3 py-1">
                        ...
                        <div class="col-sm-6">
                            <b>
                                <h6 style="font-family: 'Open Sans', sans-serif; font-size: 14px; color: #8094ae;">Start Date and Time</h6>
                            </b>
                            <p id="preview-event-start" style="color:#000; font-size: 12px"></p>
                        </div>
                        <div class="col-sm-6" id="preview-event-end-check">
                            <b>
                                <h6 style="font-family: 'Open Sans', sans-serif; font-size: 14px; color: #8094ae;">End Date and Time</h6>
                            </b>
                            <p id="preview-event-end" style="color:#000; font-size: 12px; font-family: 'Open Sans', sans-serif;"></p>
                        </div>
                    ...
                    <div class="row gy-3 py-1">
                        <div class="col-sm-6" id="preview-event-end-check">
                            <b>
                                <h6 style="font-family: 'Open Sans', sans-serif; font-size: 14px; color: #8094ae;">Venue</h6>
                            </b>
                            <p id="preview-event-venue" style="color:#000; font-size: 12px; font-family: 'Open Sans', sans-serif;"></p>
                        ...
                        <div class="col-sm-6" id="preview-event-end-check">
                            ...
                            <p id="preview-event-category_name" style="font-size: 12px; font-family: 'Open Sans', sans-serif;"></p>
                        ...
                        <div class="col-sm-6" id="preview-event-end-check">
                            <b>
                                <h6 style="font-family: 'Open Sans', sans-serif; font-size: 14px; color: #8094ae;">Issuer</h6>
                            </b>
                            <p id="preview-event-issuer" style="color:#000; font-size: 12px; font-family: 'Open Sans', sans-serif;"></p>
                        ...
                        <div class="col-sm-12" id="preview-event-end-check">
                            <b>
                                <h6 style="font-family: 'Open Sans', sans-serif; font-size: 14px; color: #8094ae;">Issuer Description</h6>
                            </b>
                            <p id="preview-event-issuerDescription"
                                style="color:#000; font-size: 12px; line-break: anywhere; font-family: 'Open Sans', sans-serif;"></p>

                        </div>

                        <div class="col-sm-12" id="preview-event-description-check">
                            <b>
                                <h6 style="font-family: 'Open Sans', sans-serif; font-size: 14px; color: #8094ae;">Event Description</h6>
                            </b>
                            <p id="modalEventDescription" style="color:#000; font-size: 12px; line-break: anywhere; font-family: 'Open Sans', sans-serif;"></p>
                        </div>
                    </div>


                    <ul class=" gx-4 mt-3">
                        <h6 class="overline-title" style="text-align: center !important;">Add To</h6>
