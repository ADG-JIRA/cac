                ...
                <ul class="nk-menu">
                    ...
                    <li class="nk-menu-item has-sub">
                        <a href="{{ url('categories') }}" class="nk-menu-link">
                            ...
                            <span class="nk-menu-text" style="color: white">Categories</span>
                        </a>
                    ...
                    <li class="nk-menu-item has-sub">
                        <a href="{{ url('events') }}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-card-view"></em></span>
                    ...
                    @if (Auth::user()->hasRole('admin'))
                        ...
                        <li class="nk-menu-item has-sub">
                            <a href="#" class="nk-menu-link nk-menu-toggle">
                                ...
                                <span class="nk-menu-text" style="color: white">Roles and Persmissions</span>
                            </a>
                            <ul class="nk-menu-sub">
                                <li class="nk-menu-item">
                                    <a href="{{ url('roles') }}" class="nk-menu-link"><span
                                            class="nk-menu-text">Roles</span></a>
                                </li>
                                <li class="nk-menu-item">
                                    <a href="{{ url('permissions') }}" class="nk-menu-link"><span
                                            class="nk-menu-text">Persmissions</span></a>
                                </li>
                            </ul><!-- .nk-menu-sub -->
                        </li><!-- .nk-menu-item -->
                    @endif
